/*Numbers*/
function run1(){document.calc.output.value += "1";}
...
function runPL(){document.calc.output.value += "(";}
function runPR(){document.calc.output.value += ")";}
...
function equal(){
	if (document.calc.output.value.length > 0){
...
/*Other*/
function clearcalc(){document.calc.output.value = "";}

function doIt(){
	var answer = document.calc.output.value;

	var answer = eval(document.calc.output.value);
	
	document.calc.output.value = answer;

}

function back(){
	document.calc.output.value = document.calc.output.value.substring(0, document.calc.output.value.length - 1); 
}